...
with row0_2:
    ...
    if selected_option in ["Select a theme"]:
        ...
        st.markdown(
            f"<h3 style='text-align: center; background-color: {color2}; padding: 5px; border-radius: 5px;font-size: 1.3vw; color: #333;'>"
            f"🌊 Current theme - {selected_option} </h3>",
            unsafe_allow_html=True
        )
        ...
        st.markdown(
            f"<h3 style='text-align: center; background-color: {color4}; padding: 5px; border-radius: 5px;font-size: 1.3vw; color: #333;'>"
            f"🪨 Current theme - {selected_option} </h3>",
            unsafe_allow_html=True
        )
